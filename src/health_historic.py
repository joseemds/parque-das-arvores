class HealthHistoric:
    ...
    def __str__(self):
        return f"(data={self.date}, temperatura={self.temperature}ºC, peso={self.weight}Kg, altura={self.height}, coleta_amostra_sangue={self.collected_blood_sample}, resultado_exame_saude_foi_ok={self.health_exam_result_was_ok}, observacao={self.observation})"
